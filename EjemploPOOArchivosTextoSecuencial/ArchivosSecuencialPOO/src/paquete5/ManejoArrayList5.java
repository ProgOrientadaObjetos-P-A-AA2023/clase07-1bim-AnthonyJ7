...
public class ManejoArrayList5 {
    ...
    public static void main(String[] args) {
        ...
        String [] lineas = {"Tara Hernandez|contratado|30","Luis Andrade|factura|35", "Ana Juarez|nombramiento|40"};
        
        // recorriod del arreglo
        ...
        for(int i = 0;i < lineas.length;i++){
            ...
            ArrayList<String> linea_partes = new ArrayList<>(
                Arrays.asList(c.split("\\|")) // ["Tara Hernandez", "contratado"]
                );
